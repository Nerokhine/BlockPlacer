...
Client client; // Replace with your server’s IP and port
String input;
...
void setup() {//upon startup of the game
  ...
  //System.out.println(dataPath("") + "\\Worlds\\");
  //System.out.println(data);
  // Folder that you want to traverse
  client = new Client(this, "25.144.235.54", 12345);
  ...
  /*minim2 = new Minim(this);
   player = minim2.loadFile("Terraria Music - Day.mp3", 2048);
   player.loop();*/
  //load up the images
...
void draw() {
  ...
  //client.write(xPos + "|" + yPos + "!"); //sends the other person your co-ordinates
  //client.clear();
  client.write(xPos + " " + yPos + "\n");
...
void keyPressed() {
  ...
  if (key == 'p') {
    ...
    if (name != null) {
      try {
        FileWriter fw = new FileWriter(data + "Worlds\\" + name + ".txt");
